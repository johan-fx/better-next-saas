			...
			<main className="overflow-hidden">
				...
				<section>
					<div className="relative py-24 md:py-36">
						...
						>
							<div className="relative mx-auto mt-12 max-w-5xl overflow-hidden rounded-3xl bg-muted md:mt-20">
								<div className="bg-background rounded-(--radius) relative m-4 overflow-hidden border border-transparent shadow-xl shadow-black/15 ring-1 ring-black/10 sm:m-8 md:m-12">
									<div>
										{/* Image placeholder for hero section demo */}
										<div className="flex h-96 w-full items-center justify-center bg-muted/50">
											<ImageIcon className="h-24 w-24 text-neutral-200" />
										</div>
									</div>
								</div>
							</div>
